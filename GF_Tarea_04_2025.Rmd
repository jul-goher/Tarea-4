...
prop_graf <- function(grafica) {
  ...
  matriz_adyacencia <- as.matrix(as_adjacency_matrix(grafica))
  matriz_distancias <- distances(grafica)
  diametro <- diameter(grafica)
  nodos_distantes <- ends(grafica, get.diameter(grafica))
